    ...
    <Lb value={selectedOption} onChange={onSelectOption}>
      {({ open }) => (
        <div className="relative w-full text-neutral-100">
          <Lb.Button className="flex h-10 w-full items-center rounded-xl bg-neutral-800 px-4 py-2 text-left text-base outline-none ring-1 ring-neutral-700 hover:ring-2 hover:ring-neutral-600 hover:ring-offset-2 hover:ring-offset-neutral-900 focus:ring-2 focus:ring-neutral-600 focus:ring-offset-2 focus:ring-offset-neutral-900 md:w-48">
